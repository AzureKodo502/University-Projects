...
public class PagamentoController extends PagamentoClass {
    ...
    public void initialize() {
        ...
        MMAA.textProperty().addListener((observable, oldValue, newValue) -> {
            // Rimuovi tutte le barre di separazione esistenti
            String cleanText = newValue.replaceAll("/", "");

            // Costruisci il testo formattato con le barre
        ...
        numcarta.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            // Costruisci il testo formattato con gli spazi
            StringBuilder formattedText = new StringBuilder();
        ...
        CVC.textProperty().addListener((observable, oldValue, newValue) -> {
            // Verifica che il nuovo testo sia composto solo da cifre e abbia al massimo 3 caratteri
        ...
        try {
            Utente utente = Inizializzazione.getInstance().getUtente(); // Otteniamo l'utente
            if (utente == null) {
